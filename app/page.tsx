  ...
  return (
    <div className={`container mx-auto px-4 py-16 ${poppins.className} dark:bg-gray-900`}>
      <section className="text-center mb-20">
        ...
        {!loggedIn ? (
          <Button onClick={login} className="bg-green-600 hover:bg-green-700 dark:bg-green-500 dark:hover:bg-green-600 text-white text-lg py-6 px-10 rounded-full font-medium transition-all duration-300 ease-in-out transform hover:scale-105">
            Get Started
